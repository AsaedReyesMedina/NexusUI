...
/* harmony export */ });
var excludeTags=Object.entries(globalThis.TAGS_OPTIONS??{}).reduce((acc,entry)=>{let[tag,option]=entry;return option.excludeFromDocsStories&&(acc[tag]=!0),acc},{}),parameters={docs:{renderer:async()=>{let{DocsRenderer}=await Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_storybook_addon-docs_node_modules_react-dom_index_js"), __webpack_require__.e("vendors-node_modules_storybook_addon-docs_dist_blocks_mjs"), __webpack_require__.e("vendors-node_modules_storybook_addon-docs_node_modules_react-dom_client_js"), __webpack_require__.e("node_modules_storybook_addon-docs_dist_DocsRenderer-PQXLIZUC_mjs-node_modules_storybook_addon-5cb44f")]).then(__webpack_require__.bind(__webpack_require__, /*! ./DocsRenderer-PQXLIZUC.mjs */ "./node_modules/@storybook/addon-docs/dist/DocsRenderer-PQXLIZUC.mjs"));return new DocsRenderer},stories:{filter:story=>(story.tags||[]).filter(tag=>excludeTags[tag]).length===0&&!story.parameters.docs?.disable}}};
...
/***/ "./node_modules/@storybook/addon-docs/node_modules/react/cjs/react.development.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/@storybook/addon-docs/node_modules/react/cjs/react.development.js ***!
  \****************************************************************************************/
...
{} else {
  module.exports = __webpack_require__(/*! ./cjs/react.development.js */ "./node_modules/@storybook/addon-docs/node_modules/react/cjs/react.development.js");
}
